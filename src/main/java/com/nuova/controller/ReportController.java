...
public class ReportController {
    ...
    public String reportOrdenEmitida(ModelMap map, @PathVariable("ordenId") Integer ordenId,
        ...
        parameters.put("apellido_nombre",
                dto.getPaciente().getApellido().toUpperCase() + " " + dto.getPaciente().getNombre().toUpperCase());
        ...
        parameters.put("nombre_obrasocial", dto.getPaciente().getObrasocial().getNombre().toUpperCase());

...
public class ReportController {
  ...
  public String reportOrdenEmitida(ModelMap map, @PathVariable("ordenId") Integer ordenId,
    ...
    parameters.put("apellido_nombre",
        dto.getPaciente().getApellido() + " " + dto.getPaciente().getNombre());
    parameters.put("localidad", dto.getPaciente().getProvincia());
    parameters.put("domicilio", dto.getPaciente().getDomicilio());

...
public class ProfesionalController {
  ...
  private Profesional transformDtoToProfesional(ProfesionalDTO p) {
    ...
    Profesional profesional =
        new Profesional(p.getApellido().toUpperCase(), p.getNombre().toUpperCase(), p.getTelefono(),
            p.getMatricula(), p.getRegistroNacional(), p.getTituloProfesional().toUpperCase(), hs,
            fechaHabilitacion, p.getNroRegistro(), validoHasta, null, null, null,
            p.getNroPoliza().toUpperCase(), vigenciaDesde, null, vigenciaHasta, null, null, null);
    ...
    profesional.setTipo(p.getTipo());
    return profesional;
  }

  private ProfesionalDTO transformProfesionalToDto(Profesional p) {
    ProfesionalDTO dto = new ProfesionalDTO();
    dto.setApellidoRazonSocial(p.getApellido() + " " + p.getNombre());

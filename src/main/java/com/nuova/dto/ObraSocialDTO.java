...
public class ObraSocialDTO {
  ...
  public String getAcciones() {
    String botonEdit = "<a class='btn btn-info btn-xs' href='formEditObraSocial/"
        + getObrasocialId() + "'><span class='icon icon-edit'></span>editar</a>&nbsp;";

    String botonDelete = "<a class='btn btn-danger btn-xs' href='formDeleteObraSocial/"
        + getObrasocialId() + "'><span class='icon icon-remove'></span>eliminar</a>";

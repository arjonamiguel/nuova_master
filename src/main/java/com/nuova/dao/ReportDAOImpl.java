...
public class ReportDAOImpl implements ReportDAO {
    ...
    public List<ReporteDetalleOrdenConsultaDto> getOrdenesPorTipoYFecha(Integer tipoOrden,
        ...
        Query query = sessionFactory.getCurrentSession()
                .createSQLQuery(
                        "CALL zp_getAllOrdenesPorTipoYFecha(:tipoOrden, :fechaDesde, :fechaHasta);")
                .setInteger("tipoOrden", tipoOrden).setDate("fechaDesde", fechaDesde)
                .setDate("fechaHasta", fechaHasta).setResultTransformer(
                        Transformers.aliasToBean(ReporteDetalleOrdenConsultaDto.class));;

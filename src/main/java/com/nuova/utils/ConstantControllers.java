...
public class ConstantControllers {
  ...
  public final static String FORM_DELETE_ORDEN_CONSULTA = "/formDeleteConsulta/{ordenId}";
  ...
  public final static String AJAX_GET_ORDENES_POR_TIPO_FECHA = "/ajaxGetReportOrdenesPorTipoYFecha";

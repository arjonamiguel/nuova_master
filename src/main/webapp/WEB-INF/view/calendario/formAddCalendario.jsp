...
<div class="panel panel-info">
		<div class="panel-heading">
			 <div class="panel-title">Nuevo Calendario</div>
		</div>
				...
				<div class="container-fluid">
						<div class="row-fluid">
							<div class="span3">
        						...
        						<div class="formInput">
        							<form:select path="resourceId" style="width:80%; margin-bottom:0px">
									<form:option value="NONE" label="Seleccione Consultorio ..."/>
									<form:options items="${consultorios}" itemLabel="value" itemValue="id" />			    
								</form:select>
        						</div>
							</div>
							<div class="span3">
        						...
        						<div class="formInput">
									<div id="calendarStart">
										<div class="input-group registration-date-time" style="padding-top:0%;">
											<input class="form-control" name="fecha_start" id="fecha-start" type="date"  onchange="updateDateFechaStart()">
					            		</div>
					        		</div> 
								</div>
							</div>
							<div class="span3">
        						...
        						<div class="formInput">
									<div id="calendarEnd">
										<div class="input-group registration-date-time" style="padding-top:0%;">
											<input class="form-control" name="fecha_end" id="fecha-end" type="date"  onchange="updateDateFechaEnd()">
					            		</div>
					        		</div> 
								</div>
							...
							<div class="span3">
        						...
        						<div class="formInput">
        						<form:select path="title" style="width:80%; margin-bottom:0px">

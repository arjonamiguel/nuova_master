...
<div class="tab-content" style="height: 400px">
	<table class="table" style="width: 100%">
		<tr>
			...
			<td style="text-align: left" colspan="5"><input type="hidden" disabled="disabled"
				...
				placeholder="Ingrese Especialidad ..." autocomplete="off" disabled="disabled" 
	...
	<table class="table" style="width: 100%">
		...
		<tr>
			...
			<td><form:checkbox path="fueraCartilla" id="fueraCartilla" cssClass="largerCheckbox" disabled="true" 

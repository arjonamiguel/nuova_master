...
<div class="tab-content" style="height: 400px">
	<table class="table" style="width: 100%">
		<tr>
			...
			<td style="text-align: left" colspan="5"><input type="hidden"
				...
				value="${especialidadView}"> <a href="#"
				title="Nueva Especialidad" id="btnEspecialidad"> <img
					src="/nuova/resources/img/list_add_16x16.png">
			</a> </a></td>
			<td style="width: 15%"><form:label path="profesionalId">Profesional*</form:label>
			</td>
			<td style="text-align: left" colspan="5"><form:select
					path="profesionalId" style="width:80%; ">
					<form:option value="-1" label="Seleccione Profesional ..." />
					<form:options items="${profesionales}" itemLabel="value"
						itemValue="id" />
				</form:select> <a href="#" title="Nuevo Profesional" id="btnProfesional"> <img
					src="/nuova/resources/img/list_add_16x16.png">
			</a></td>
		</tr>
	</table>
	...
	<table class="table" style="width: 100%">
		...
		<tr>
			...
			<td><form:checkbox path="fueraCartilla" id="fueraCartilla"
					cssClass="largerCheckbox" onchange="enabledFueraCartilla()" /></td>
		</tr>
		<tr>

...
<div class="container">
	...
	<!-- Collect the nav links, forms, and other content for toggling -->
		 ...
		 <ul class="nav navbar-nav">
				...
				<sec:authorize access="hasRole('ROLE_ADMIN')">
				<li class="dropdown" >
				<a href="#" id="calendario"  class="dropdown-toggle" data-toggle="dropdown"><i class="icon-list-alt"></i>&nbsp;&nbsp;Caja<span class="caret"></a>
				<ul class="dropdown-menu" role="menu">
		                <li><a href="/nuova/mainCalendario">Administracion de Caja</a></li>		               
              	</ul>
				</li>
				</sec:authorize>

	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Reporte Afiliados Atendidos</h4>
			</div>
			...
			<div class="alert alert-danger" id="msj_afiliadoatendido" style="visibility: hidden;">														
  			<strong>Importante!</strong> Usted debe seleccionar un rango de fechas.<br>
  			Seleccione Fecha Desde y Fecha Hasta, el campo especialidad no es requerido.
  			</div>

...
<form:form method="post" action="/nuova/deletePaciente" commandName="paciente">
	    ...
	    <tr>
	        ...
	        <td><form:input path="dni" disabled="true"/><form:hidden path="pacienteId" /></td>
	    ...
	    <tr>	    	
	        ...
	        <td colspan=""><form:textarea path="domicilio" cssStyle="width:94%" disabled="true"/></td>
	        <td><form:label path="liberado">Liberado:</form:label></td>
	        <td>	        	
	        	<form:checkbox path="liberado" disabled="true"/>	        	
	        </td>
	    </tr>	
	    <tr>
     	<td colspan="4"></td>	
 	    	...
 	    	<td>
 	    		<input type="checkbox" name="titular"  ${paciente.checkedTitular} disabled="true"/>
 	    	</td>        	
     	</tr>       
	    <tr style="background-color:#d9edf7;color:#31708f;">
    	...
    	<tr>
        	<td colspan="6">
           	<div>
				...
				<form:select path="obrasocial.nombre" style="width:70%; margin-bottom:0px" disabled="true">
					...
					<INPUT type="button" value="Agregar" onclick="addRow('tb_paciente_obrasocial')" class="btn btn-info" disabled="disabled"/>
	    	...
	    	<tr>
		        ...
		        <td><button type='button' class='btn btn-link' onClick='Eliminar(this.parentNode.parentNode.rowIndex)' disabled="disabled">eliminar</button></td>
		        <%index++;%>
	    	</tr>
	</c:forEach>
			    </TABLE>
     ...
     <c:if test="${isTitular}">
	    ...
	    <tr>
		    ...
		    <INPUT type="button" value="Nuevo Adherente" onclick="nuevoAdherente()" class="btn btn-success" disabled="disabled"/>
			</div>

...
<body style="background-color: #e5e5e5;">
	...
	<div class="mainContainer">
		<div class="panelContainer">
			<form:form method="post" action="/nuova/editReintegro"
				commandName="reintegro">
				<form:hidden path="pacienteId"/>
				<form:hidden path="reintegroId"/>
				<div class="panel panel-info">
					<div class="panel-heading">
						<div class="panel-title">Editar Reintegro</div>
					</div>
						...
						<div class="container-fluid">
							...
							<div class="row-fluid">
								...
								<div class="span3">
									...
									<div class="formInput">
										<form:select path="estado" style="width:83%; margin-bottom:0px">
										<form:option value="NONE" label="Seleccione Estado ..."/>
										<form:options items="${estadosReintegrosList}"  />			    
										</form:select>
									</div>
								</div>
								<div class="span4">
							...
							<div class="span12">
								<div style="float: right;">
									<input type="button" value="Cancelar"
										onclick="location.href='/nuova/mainReintegro';" class="btn" />
								</div>
...
document.getElementById("fecha_inicio").value=document.getElementById("fechaDesde").value;
document.getElementById("fecha_reintegro").value=document.getElementById("fechaReintegro").value;
